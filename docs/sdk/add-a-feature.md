...
(`docs/features/_car_domain/feature-ids/dump.sh <trim>` — see [`../features/_car_domain/feature-ids/README.md`](../features/_car_domain/feature-ids/README.md)).
...
separate workflow — see [`../features/_car_domain/README.md`](../features/_car_domain/README.md).
