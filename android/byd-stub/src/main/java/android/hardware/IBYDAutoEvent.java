 ...
 * {@code byd/_dudu_extract/dex/smali_dudu/c1/com/dudu/autoui/manage/console/impl/byd/api/}:
 *
 * <pre>
 *   invoke-interface {p1}, Landroid/hardware/IBYDAutoEvent;->getEventType()I
 *   invoke-interface {p1}, Landroid/hardware/IBYDAutoEvent;->getValue()I
 *   invoke-interface {p1}, Landroid/hardware/IBYDAutoEvent;->getDoubleValue()D
 * </pre>
 *
