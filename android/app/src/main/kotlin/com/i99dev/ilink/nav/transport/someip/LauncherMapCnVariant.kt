 ...
 *
 * ## Wire facts (derived, see docs/nav-hud/openbyd-2421-launchermap-spike.md)
 ...
 * 3. **Single-fire tail — ASSUMED, not proven.** The decompiled source appears to
 *    send the 7-event tail twice: once inside the lane branch and once after it.
 *    We read that as a decompiler artifact of a `return` (the duplicated blocks
 *    are byte-identical, and lines 193–250 / 257+ read as an if/else whose `else`
 *    jadx flattened) and emit the tail once.
 *
