 ...
 *
 * Recipe (decompile-verified — see `byd/l5/BUILD_GUIDE_PASSENGER_
 * APP.md` for the original provenance + the byd/l5 RE doc for the
 * quickShare opcode discovery in a reference DiShare launcher):
 *
 ...
 * be authorized. The decompile-verified quickShare op replaced
...
class DishareTransport(private val applicationContext: Context) {
     ...
     *
     * Implements the decompile-verified recipe — five binder
     ...
     * DiShare launcher's RouteEngine — see the byd/l5 RE doc for
     * the disassembly trail and the specific op=8 / op=11 evidence.
     *
    ...
    private inner class DishareSession {
        ...
        // a faithful port of the user's WORKING reference app (its
        // DiShare client callback, decompiled 2026-05-18) — verified
        // to drive DiShare correctly on this exact car.
        //
         ...
         *
         *  Verified opcode + parcel shape by decompiling a
         *  reference DiShare launcher's `DiShareCore.quickShare`.
    ...
    companion object {
        ...
        // Decompile-verified opcodes — see byd/l5 doc + the
        // reference launcher's DiShareCore disassembly.
