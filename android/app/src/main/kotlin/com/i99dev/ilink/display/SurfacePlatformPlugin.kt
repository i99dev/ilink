...
class SurfacePlatformPlugin(
    ...
    private fun tryAmStartActivity(
        ...
        // amap stays z-ordered above us. See `docs/miniapp/CLUSTER_Z_ORDER.md`.
     ...
     * `BottomEmptyActivity`. This is the documented "hijack the
     * slot" approach from `byd/l8/dlink-unit/Gauge Cluster/`.
     *
