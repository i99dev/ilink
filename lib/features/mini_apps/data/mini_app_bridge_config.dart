...
/// Hosts of the retired hosted backend. These are deliberately the OLD
/// i99dash names, not iLINK ones: the point is to keep refusing traffic to
/// infrastructure that no longer exists (and whose DNS could be claimed by
/// someone else), so they must not be renamed along with the app.
